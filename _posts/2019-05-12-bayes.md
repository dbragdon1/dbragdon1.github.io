...
![]({{ site.url }}{{ site.baseurl }}/images/bayes-images/algo.PNG)
...
plt.show()
```
![]({{ site.url }}{{ site.baseurl }}/images/bayes-images/bin_compare.png)
...
![]({{ site.url }}{{ site.baseurl }}/images/bayes-images/gram_compare.png)
